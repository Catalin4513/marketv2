...
class Standard_action_widget_RssWidget_536de791f9552d9e336232412fcee5a0d5c86a7b extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output24 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, ['']);
